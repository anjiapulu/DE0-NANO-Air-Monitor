...
module DE0_NANO_QSYS_mm_interconnect_0_addr_router_default_decode
  #(
...
module DE0_NANO_QSYS_mm_interconnect_0_addr_router
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    DE0_NANO_QSYS_mm_interconnect_0_addr_router_default_decode the_default_decode(
